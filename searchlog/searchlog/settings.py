"""
Django settings for searchlog project.
...
SECRET_KEY = '-qsjwm5iy%(yu+rq*u$3t4o+q(-sxn#o=0qt=mpb)8efto%lxd'
...
WSGI_APPLICATION = 'searchlog.wsgi.application'
